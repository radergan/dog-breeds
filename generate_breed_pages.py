...
def load_template():
    ...
    breed_content = '''<div class="preview-section show" id="preview-section">
            ...
            <div class="breed-content">
                ...
                <!-- Community Gallery -->
                <div class="community-gallery" id="community-gallery" style="display: none;">
                    <h2>Meet the {{BREED_NAME}} Community</h2>
                    <p class="gallery-subtitle">Real {{BREED_NAME}}s from our community members</p>
                    <div id="community-dogs-grid" class="community-dogs-grid"></div>
    ...
    footer_section = footer_section.replace(
        ...
        async function loadCommunityDogs() {
            ...
            try {
                ...
                // Only show gallery if we have dogs
                if (data.success && data.dogs.length > 0) {
                    ...
                    // No dogs or error - keep gallery hidden
                    gallerySection.style.display = 'none';
                }
                
            } catch (error) {
                console.error('Error loading community dogs:', error);
                // On error, hide the entire gallery section
                gallerySection.style.display = 'none';
            }
        }
    </script>'''
